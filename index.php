<?php
$conn = new mysqli('localhost','root','','yves');
...
&& isset($_COOKIE['password'])) { echo  $_COOKIE['password']; } ?>">
					...
					<div class="container-login100-form-btn">
                        ...
                        <div id="twitter-login-container" style="margin-top: 30px">
							<a href="#" class="twitter-login-button">Log in with Twitter</a>
                        </div>
					</div>
...
<!--===============================================================================================-->
	...
	<script>
		...
		twttr.ready(function() {
			twttr.widgets.createLoginButton(
			'response.php',
			document.getElementById('twitter-login-container'),
			{
				size: 'large',
				align: 'center',
				authComplete: function(result) {
					console.log("User authenticated with Twitter: ", result);
